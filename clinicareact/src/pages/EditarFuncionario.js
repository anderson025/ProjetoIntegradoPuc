...
const editarPut = async() =>{
  ...
  await axios.put(BASE_URL +"/"+ funcionario.id, funcionario)
  .then(response => {
    var resposta = response.data;
    var dadosAuxiliar = data;
    dadosAuxiliar.map(funcionarioEditado => {
      if(funcionarioEditado.id === funcionario.id){
        funcionarioEditado.nome = resposta.nome;
        funcionarioEditado.dataNascimento =  resposta.dataNascimento;
        funcionarioEditado.idade = resposta.idade;
      }
    });
    ...
    >      
      ...
      <div>
        ...
        <TextField
          ...
          name="idade"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.idade}
        />
        ...
        <TextField
          ...
          name="dataNascimento"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.dataNascimento}
        />
        <TextField
          required
          id="id-rg"
          ...
          name="rg"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.rg}
        />
        <TextField
          required
          id="id-cpf"
          ...
          name="cpf"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.cpf}
        />
        <TextField          
          id="id-telefone"
          label="Telefone:"
          ...
          name="telefone"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.telefone}
        />
        <TextField
          required
          id="id-celular"
          ...
          name="celular"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.celular}
        />
        ...
        <TextField
          ...
          variant="standard"
          // value = {funcionarioSelecionado && funcionarioSelecionado.profissao}
        ...
        <TextField
          ...
          variant="standard"
          //value = {funcionarioSelecionado && funcionarioSelecionado.sexo}
        >
          {sexoVet.map((option) => (
            <MenuItem key={option.value} value={option.value} name="rg"
            onChange={funcionarioChange} >
        ...
        <TextField
          ...
          name="email"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.email}
        />
        <FormGroup>
      ...
      <TextField
          ...
          name="convenio"
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.convenio}
        />
        <TextField
          required
          ...
          onChange={funcionarioChange}
          value = {funcionarioSelecionado && funcionarioSelecionado.carteiraConvenio}
        />
      </div>
      ...
      <br/><h5>Endereço</h5>
          ...
          value = {funcionarioSelecionado && funcionarioSelecionado.endereco.rua}
      ...
      <div>
        <Stack direction="row" spacing={2}>
            <Button variant="contained" onClick={() => editarPut()}>Salvar</Button> 
